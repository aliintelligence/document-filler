...
-- Also create a function to add default permissions for existing contracts that don't have them
CREATE OR REPLACE FUNCTION fix_missing_contract_permissions()
RETURNS void AS $$
BEGIN
    ...
    -- Add missing sales_rep permissions
    INSERT INTO contract_permissions (contract_id, role, can_access)
...
SELECT fix_missing_contract_permissions();